...
This file is not in the correct format.`,"warning","Paint")}}readPalette(t){const i=new DataView(t),n=new TextDecoder;if(n.decode(t.slice(0,4))!=="RIFF")throw new Error("Non-RIFF palettes are not supported.");if(n.decode(t.slice(8,12))!=="PAL ")throw new Error("Only PAL form types are supported.");if(n.decode(t.slice(12,16))!=="data")throw new Error("Expected a data chunk.");const a=[],l=i.getUint16(22,!0);for(let p=0;p<l;p++){const h=24+p*4,c=i.getUint8(h),d=i.getUint8(h+1),u=i.getUint8(h+2);a.push(`rgb(${c} ${d} ${u})`)}return a.slice(0,26)}}class rr{isChecked({drawOpaque:t}){return t}execute(t){t.drawOpaque=!t.drawOpaque,b(t.element)}}const sr={caption:"Options",mnemonic:"O",helpText:"",entries:[{caption:"Edit Colors…",mnemonic:"E",helpText:"Creates a new color."},{caption:"Get Colors…",mnemonic:"G",helpText:"Uses a previously saved palette of colors.",instance:new or},{caption:"Save Colors…",mnemonic:"S",helpText:"Saves the current palette of colors to a file.",instance:new nr},{caption:"Draw Opaque",mnemonic:"D",helpText:"Makes the current selection either opaque or transparent.",instance:new rr}]};class ar{async execute(t){const i=await vt("paint-dialog-custom-zoom",{currentMagnifierSize:t.magnifierSize});i?.magnifierSize&&(t.magnifierSize=i.magnifierSize,b(t.element))}}class lr{execute(t){t.magnifierSize=4,b(t.element)}}class cr{execute(t){t.magnifierSize=1,b(t.element)}}class hr{isChecked(t){return t.text.showToolbar??!1}canExecute(t){return t.text.active}execute(t){t.text.showToolbar=!t.text.showToolbar,Y(t),b(t.element)}}class pr{async execute({canvas:t}){t&&await t.requestFullscreen()}}class dr{isChecked({view:{statusBar:t}}){return t}execute(t){t.view.statusBar=!t.view.statusBar,b(t.element)}}class ur{isChecked({view:{toolBox:t}}){return t}execute(t){t.view.toolBox=!t.view.toolBox,b(t.element)}}class gr{isChecked({view:{colorBox:t}}){return t}execute(t){t.view.colorBox=!t.view.colorBox,b(t.element)}}const fr={caption:"View",mnemonic:"V",helpText:"",entries:[{caption:"Tool Box",shortcut:"Ctrl+T",mnemonic:"T",helpText:"Shows or hides the tool box.",instance:new ur},{caption:"Color Box",shortcut:"Ctrl+A",mnemonic:"C",helpText:"Shows or hides the color box.",instance:new gr},{caption:"Status Bar",mnemonic:"S",helpText:"Shows or hides the status bar.",instance:new dr},{separator:!0},{caption:"Zoom",mnemonic:"Z",helpText:"",entries:[{caption:"Normal Size",mnemonic:"N",shortcut:"Ctrl+PgUp",helpText:"Zooms the picture to 100%.",instance:new cr},{caption:"Large Size",mnemonic:"L",shortcut:"Ctrl+PgDn",helpText:"Zooms the picture to 400%.",instance:new lr},{caption:"Custom…",mnemonic:"u",helpText:"Zooms the picture.",instance:new ar},{separator:!0},{caption:"Show Grid",mnemonic:"G",shortcut:"Ctrl+G",helpText:"Shows or hides the grid."},{caption:"Show Thumbnail",mnemonic:"h",helpText:"Shows or hides the thumbnail view of the picture."}]},{caption:"View Bitmap",mnemonic:"V",shortcut:"Ctrl+F",helpText:"Displays the entire picture.",instance:new pr},{caption:"Text Toolbar",mnemonic:"e",helpText:"Shows or hides the text toolbar.",instance:new hr}]},ti=[Zo,qo,fr,ir,sr,Jo];var vr=Object.defineProperty,mr=Object.getOwnPropertyDescriptor,wt=(e,t,i,n)=>{for(var o=n>1?void 0:n?mr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&vr(t,i,o),o};const Xt="For Help, click Help Topics on the Help Menu.";let Z=class extends w{constructor(){super(),this.areaText="",this.coordinateText="",this.helpText=Xt,this.drawingContext=_,this.previousTitle="",this.areaText="",this.coordinateText="",this.helpText=Xt,this.drawingContext=_,this.drawingContext.history=new xo(this.drawingContext),this.addEventListener("set-help-text",(e=>{this.helpText=e.detail??Xt})),this.addEventListener("coordinate",(e=>{this.coordinateText=e.detail?`${e.detail.x},${e.detail.y}`:""})),this.addEventListener("area",(e=>{this.areaText=e.detail?`${e.detail.width}x${e.detail.height}`:""})),this.addEventListener("drawing-context-changed",(e=>{const t=e.detail;mo(t),this.drawingContext=t})),this.addEventListener("invoke-action",(e=>{e.detail(this.drawingContext)})),this.addEventListener("canvas-ready",()=>wo(this.drawingContext)),this.beforeUnloadListener=this.onBeforeUnload.bind(this),window.addEventListener("beforeunload",this.beforeUnloadListener),Ao(this),this.registerHotkeys(ti)}static get styles(){return x`
    ...
    </div>`}};ei=br([y("paint-button")],ei);var xr=Object.defineProperty,yr=Object.getOwnPropertyDescriptor,et=(e,t,i,n)=>{for(var o=n>1?void 0:n?yr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&xr(t,i,o),o};let K=class extends w{constructor(){super(...arguments),this.drawingContext=_,this.inCanvas=!1,this.canvasWidth=screen.width,this.canvasHeight=screen.height,this.pointerDown=!1,this.previewColor="primary",this.lastPointerEventTime=0}static get styles(){return x`
      :host {
        height: 100%;
    ...
    `}swapColors({pointerType:e}){if(["pen","touch"].includes(e)){const{primary:t,secondary:i}=this.drawingContext.colors;this.drawingContext.colors.primary=i,this.drawingContext.colors.secondary=t,b(this)}}};Ui([m()],le.prototype,"drawingContext",2);le=Ui([y("paint-color-box")],le);var Cr=Object.defineProperty,Pr=Object.getOwnPropertyDescriptor,It=(e,t,i,n)=>{for(var o=n>1?void 0:n?Pr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Cr(t,i,o),o};let dt=class extends w{constructor(){super(),this.drawingContext=_,this.index=0,this.addEventListener("click",()=>{this.dispatchColorEvent("primary")}),this.addEventListener("contextmenu",e=>{this.dispatchColorEvent("secondary"),e.preventDefault()}),this.addEventListener("dblclick",()=>{this.openColorPicker()})}get color(){return this.drawingContext.palette[this.index]}static get styles(){return x`
      :host {
        position: relative;
        border: 1px solid var(--button-light);
    ...
    />`}};It([m()],dt.prototype,"drawingContext",2);It([m({type:Number})],dt.prototype,"index",2);It([Ce("input")],dt.prototype,"colorInput",2);dt=It([y("paint-color-picker")],dt);var Er=Object.defineProperty,_r=Object.getOwnPropertyDescriptor,Be=(e,t,i,n)=>{for(var o=n>1?void 0:n?_r(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Er(t,i,o),o};let kt=class extends w{constructor(){super(...arguments),this.primaryColor="",this.secondaryColor=""}static get styles(){return x`
      :host {
        border: 1px solid var(--button-light);
        border-top-color: var(--button-dark);
        border-left-color: var(--button-dark);
    ...
    `}};Be([m()],kt.prototype,"primaryColor",2);Be([m()],kt.prototype,"secondaryColor",2);kt=Be([y("paint-color-switcher")],kt);var Sr=Object.getOwnPropertyDescriptor,Or=(e,t,i,n)=>{for(var o=n>1?void 0:n?Sr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=s(o)||o);return o};let ii=class extends w{static get styles(){return x`
      :host {
        display: inline-block;
        box-sizing: border-box;
        width: 3px;
    ...
    `}render(){return f``}};ii=Or([y("paint-handle")],ii);var Tr=Object.getOwnPropertyDescriptor,kr=(e,t,i,n)=>{for(var o=n>1?void 0:n?Tr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=s(o)||o);return o};let ni=class extends w{static get styles(){return x`
      :host {
        box-sizing: border-box;
        border: 1px solid var(--button-dark);
        border-bottom-color: var(--button-light);
    ...
    `}render(){return f`<slot></slot>`}};ni=kr([y("paint-inset-container")],ni);var Hr=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,Re=(e,t,i,n)=>{for(var o=n>1?void 0:n?Mr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Hr(t,i,o),o};let Ht=class extends w{constructor(){super(),this.entries=[],this.drawingContext=_,this.addEventListener("click",e=>e.stopPropagation())}static get styles(){return x`
      :host {
        position: absolute;
        top: 100%;
        left: 0;
    ...
    `}isChecked(e){return!!(e.instance?.isChecked&&e.instance.isChecked(this.drawingContext))}isDisabled({instance:e,entries:t}){return!(t||e&&(!e.canExecute||e.canExecute(this.drawingContext)))}execute(e){!this.isDisabled(e)&&e.instance?.execute&&(this.dispatchEvent(new CustomEvent("invoke-action",{detail:e.instance.execute.bind(e.instance),bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("action-executed",{bubbles:!0,composed:!0})))}setHelpText(e){this.dispatchEvent(new CustomEvent("set-help-text",{detail:e,bubbles:!0,composed:!0}))}};Re([m()],Ht.prototype,"entries",2);Re([m()],Ht.prototype,"drawingContext",2);Ht=Re([y("paint-menu")],Ht);var Dr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,jt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Vr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Dr(t,i,o),o};let ut=class extends w{constructor(){super(),this.entries=[],this.drawingContext=_,this.activeMenu=null,document.addEventListener("click",()=>this.activeMenu=null),this.addEventListener("action-executed",()=>this.activeMenu=null)}static get styles(){return x`
      :host {
        background-color: var(--button-face);
        display: flex;
        height: 20px;
    ...
    `}};zt([m()],gt.prototype,"helpText",2);zt([m()],gt.prototype,"coordinateText",2);zt([m()],gt.prototype,"areaText",2);gt=zt([y("paint-status-bar")],gt);function Ur(e){e.includes("BlinkMacSystemFont")&&console.warn("break-styled-lines: Using BlinkMacSystemFont can cause Chrome to crash in certain environments!")}function Le(e){return Array.isArray(e)&&(e.length>0?typeof e[0]=="string":!0)}function Ii(e){return Array.isArray(e)&&(e.length>0?!Le(e):!0)}function Ir(e,t,i,n){const o=e.text.split("").reduce((a,l)=>{const p=a[a.length-1]||"",h=p.slice(-1);return l===" "&&h!==" "?[...a,l]:l!==" "&&h===" "?[...a,l]:[...a.slice(0,-1),`${p}${l}`]},[]),{lastLineWidth:r,lines:s}=o.reduce((a,l)=>{n.font=e.font;const{width:p}=n.measureText(l),h=a.lastLineWidth+p;if(h<=t){const g=[...a.lines.slice(-1),l].join("");return{lastLineWidth:h,lines:[...a.lines.slice(0,-1),g]}}if(p>t&&a.lastLineWidth===0)return{lastLineWidth:p,lines:[...a.lines.slice(0,-1),l]};const d=a.lines.slice(-1).join(""),u=[...a.lines.slice(0,-1),d.trimEnd()];return l.trim().length===0?{lastLineWidth:0,lines:[...u,""]}:{lastLineWidth:p,lines:[...u,l]}},{lastLineWidth:i,lines:[]});return{lastLineWidth:r,text:s.join(`
`)}}function Zt(e,t){const i="OffscreenCanvas"in window,n=document.createElement("canvas"),o=i?n.transferControlToOffscreen():n;o.width=t;const r=o.getContext("2d");return r?e.reduce((s,a)=>{const{lastLineWidth:l,text:p}=Ir(a,t,s.lastLineWidth,r);return{lastLineWidth:l,lines:[...s.lines,p]}},{lastLineWidth:0,lines:[]}).lines:(console.warn("No canvas context was found, so the string was left as is!"),e.map(({text:s})=>s))}function jr(e,t){return Ii(e)?e.map(({text:i,font:n})=>({text:Yt(i),font:n||t})):Le(e)?e.map(i=>({text:Yt(i),font:t})):[{text:Yt(e),font:t}]}var zr=/(\r\n|\n|\r)/gm;function Yt(e){return e.replace(zr," ")}function Nr(e,t,i){Ur(i);const n=jr(e,i);return Le(e)||Ii(e)?Zt(n,t):Zt(n,t)[0]}var Kr=Nr,qr=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,Fe=(e,t,i,n)=>{for(var o=n>1?void 0:n?Wr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&qr(t,i,o),o};let ft=class extends w{constructor(){super(...arguments),this.editingActive=!1,this.drawingContext=_}static get styles(){return x`
      textarea {
        position: absolute;
        box-sizing: border-box;
...
`)).reduce((v,A)=>v.concat(A),[]).forEach((v,A)=>{const F=(t??0)+d,S=(i??0)+r+g*A;if(!(S-(i??0)>=(o??0))&&(e.fillText(v,F,S),p)){const{width:O}=e.measureText(v);e.fillRect(F,S+1,O,1)}})}static getLineHeight(e,t){const i=e.measureText("");return typeof i.fontBoundingBoxAscent=="number"&&typeof i.fontBoundingBoxDescent=="number"?i.fontBoundingBoxAscent+i.fontBoundingBoxDescent:t*1.2}};Fe([m()],ft.prototype,"drawingContext",2);Fe([Ce("textarea")],ft.prototype,"textarea",2);ft=Fe([y("paint-text-area")],ft);var Qr=Object.defineProperty,Gr=Object.getOwnPropertyDescriptor,ji=(e,t,i,n)=>{for(var o=n>1?void 0:n?Gr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Qr(t,i,o),o};let ce=class extends w{static get styles(){return x`
      :host {
        display: inline-block;
        box-sizing: border-box;
        width: 25px;
    ...
    `}setSize(e){this.drawingContext.airbrushSize=e,b(this)}};zi([m({type:Object})],he.prototype,"drawingContext",2);he=zi([y("paint-tool-airbrush")],he);var Yr=Object.getOwnPropertyDescriptor,Jr=(e,t,i,n)=>{for(var o=n>1?void 0:n?Yr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=s(o)||o);return o};let ri=class extends w{static get styles(){return x`
      :host {
        background-color: var(--button-face);
        padding-right: 1px;
      }
    `}render(){return f`<slot></slot>`}};ri=Jr([y("paint-tool-bar")],ri);var ts=Object.defineProperty,es=Object.getOwnPropertyDescriptor,Ue=(e,t,i,n)=>{for(var o=n>1?void 0:n?es(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ts(t,i,o),o};let Mt=class extends w{constructor(){super(...arguments),this.drawingContext=_}static get styles(){return x`
      :host {
        display: flex;
        flex-flow: row wrap;
    ...
    `}render(){return f`${this.brushConfigs.map(({type:e,sizes:t})=>t.map(({value:i,path:n})=>f`<div
        ...
        </div>`))}`}onSelect(e,t){this.drawingContext.brush.type=e,this.drawingContext.brush.size=t,b(this)}};Ni([m()],pe.prototype,"drawingContext",2);pe=Ni([y("paint-tool-brush")],pe);var os=Object.defineProperty,rs=Object.getOwnPropertyDescriptor,Ki=(e,t,i,n)=>{for(var o=n>1?void 0:n?rs(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&os(t,i,o),o};let de=class extends w{constructor(){super(...arguments),this.drawingContext=_}static get styles(){return x`
      :host {
        display: block;
      }
    `}render(){this.style.backgroundColor=this.drawingContext?.previewColor??"transparent"}};Ki([m()],de.prototype,"drawingContext",2);de=Ki([y("paint-tool-color-preview")],de);var ss=Object.defineProperty,as=Object.getOwnPropertyDescriptor,qi=(e,t,i,n)=>{for(var o=n>1?void 0:n?as(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ss(t,i,o),o};let ue=class extends w{constructor(){super(...arguments),this.drawingContext=_}static get styles(){return x`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 1px 0;
    ...
    `}getClasses(e){return[...e===this.drawingContext.drawOpaque?["selected"]:[],...e?["opaque"]:["transparent"]].join(" ")}selectValue(e){this.drawingContext.drawOpaque=e,b(this)}};qi([m()],ue.prototype,"drawingContext",2);ue=qi([y("paint-tool-draw-opaque")],ue);var ls=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,Wi=(e,t,i,n)=>{for(var o=n>1?void 0:n?cs(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ls(t,i,o),o};let ge=class extends w{constructor(){super(...arguments),this.drawingContext=_,this.eraserSizes=[4,6,8,10]}static get styles(){return x`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 1px;
    ...
    `}getStyle(e){return`width: ${e}px; height: ${e}px`}selectSize(e){this.drawingContext.eraserSize=e,b(this)}};Wi([m()],ge.prototype,"drawingContext",2);ge=Wi([y("paint-tool-eraser-size")],ge);var hs=Object.defineProperty,ps=Object.getOwnPropertyDescriptor,Qi=(e,t,i,n)=>{for(var o=n>1?void 0:n?ps(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&hs(t,i,o),o};let fe=class extends w{constructor(){super(...arguments),this.drawingContext=_,this.fillStyles=[{stroke:!0,fill:!1},{stroke:!0,fill:!0},{stroke:!1,fill:!0}]}static get styles(){return x`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 3px 2px;
    ...
    `}isSelected({stroke:e,fill:t}){return e===this.drawingContext.fillStyle.stroke&&t===this.drawingContext.fillStyle.fill}getClasses({stroke:e,fill:t}){return[...e?["stroke"]:[],...t?["fill"]:[]].join(" ")}onSelect(e){this.drawingContext.fillStyle=e,b(this)}};Qi([m()],fe.prototype,"drawingContext",2);fe=Qi([y("paint-tool-fill-style")],fe);var ds=Object.defineProperty,us=Object.getOwnPropertyDescriptor,Gi=(e,t,i,n)=>{for(var o=n>1?void 0:n?us(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ds(t,i,o),o};let ve=class extends w{constructor(){super(...arguments),this.drawingContext=_,this.lineWidths=[1,2,3,4,5]}static get styles(){return x`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 1px 2px;
