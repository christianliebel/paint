 ...
 */function fi(e,t){return(i,n,o)=>{const r=s=>{var a;return((a=s.renderRoot)==null?void 0:a.querySelector(e))??null};return An(i,n,{get(){return r(this)}})}}var yn=Object.defineProperty,$n=Object.getOwnPropertyDescriptor,Ce=(e,t,i,n)=>{for(var o=n>1?void 0:n?$n(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&yn(t,i,o),o};let Et=class extends b{static get styles(){return A`
    ...
    `}getFreeMemoryInKB(){if(typeof this.totalFreeMemory>"u")return"???";const e=Math.round(this.totalFreeMemory/1024);return Intl.NumberFormat("en-US").format(e)}getFreeMemoryPercentage(){return typeof this.freeMemoryPercentage>"u"?"???":Math.round(this.freeMemoryPercentage)}onOK(){this.dispatchEvent(new CustomEvent("close"))}};Ce([m({attribute:!1})],Et.prototype,"totalFreeMemory",2);Ce([m({attribute:!1})],Et.prototype,"freeMemoryPercentage",2);Et=Ce([y("paint-dialog-about")],Et);function mt(e,t={}){return new Promise(i=>{var r;const n=(r=document.querySelector("paint-app"))==null?void 0:r.shadowRoot,o=document.createElement(e);Object.entries(t).forEach(([s,a])=>o[s]=a),o.addEventListener("close",s=>{n==null||n.removeChild(o),i(s.detail)}),n==null||n.appendChild(o)})}function Rt(e,t=null,i="",n="ok"){return mt("paint-dialog-message-box",{prompt:e,icon:t,title:i,layout:n})}function T(e,t){const i=t?e.indexOf(t):-1;return f`${e.substring(0,i)}<span class="mnemonic"
      >${t}</span
    >${e.substring(i+1)}`}var Pn=Object.defineProperty,Cn=Object.getOwnPropertyDescriptor,bt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Cn(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Pn(t,i,o),o};let Y=class extends b{constructor(){super(...arguments),this.width="",this.height="",this.unit="pels",this.color="colors",this.units=[{value:"inches",label:"Inches",mnemonic:"I"},{value:"cm",label:"Cm",mnemonic:"m"},{value:"pels",label:"Pels",mnemonic:"P"}],this.colors=[{value:"black-and-white",label:"Black and white",mnemonic:"B"},{value:"colors",label:"Colors",mnemonic:"l"}]}static get styles(){return A`
      :host {
        position: absolute;
        left: 0;
        bottom: 0;
    ...
    `:f``}async onFontListClick(){Qn()&&(this.fonts=await Ye())}};Se([m({type:Object})],Mt.prototype,"drawingContext",2);Se([M()],Mt.prototype,"fonts",2);Mt=Se([y("paint-dialog-text-toolbar")],Mt);var Zn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,et=(e,t,i,n)=>{for(var o=n>1?void 0:n?Yn(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Zn(t,i,o),o};let K=class extends b{constructor(){super(...arguments),this.prompt="",this.title="",this.icon=null,this.layout="ok"}static get styles(){return A`
      paint-window {
        position: absolute;
        top: 0;
...
This file is not in the correct format.`,"warning","Paint")}}readPalette(t){const i=new DataView(t),n=new TextDecoder;if(n.decode(t.slice(0,4))!=="RIFF")throw new Error("Non-RIFF palettes are not supported.");if(n.decode(t.slice(8,12))!=="PAL ")throw new Error("Only PAL form types are supported.");if(n.decode(t.slice(12,16))!=="data")throw new Error("Expected a data chunk.");const a=[],l=i.getUint16(22,!0);for(let p=0;p<l;p++){const h=24+p*4,c=i.getUint8(h),d=i.getUint8(h+1),u=i.getUint8(h+2);a.push(`rgb(${c} ${d} ${u})`)}return a.slice(0,26)}}class nr{isChecked({drawOpaque:t}){return t}execute(t){t.drawOpaque=!t.drawOpaque,w(t.element)}}const or={caption:"Options",mnemonic:"O",helpText:"",entries:[{caption:"Edit Colors…",mnemonic:"E",helpText:"Creates a new color."},{caption:"Get Colors…",mnemonic:"G",helpText:"Uses a previously saved palette of colors.",instance:new ir},{caption:"Save Colors…",mnemonic:"S",helpText:"Saves the current palette of colors to a file.",instance:new er},{caption:"Draw Opaque",mnemonic:"D",helpText:"Makes the current selection either opaque or transparent.",instance:new nr}]};class rr{async execute(t){const i=await mt("paint-dialog-custom-zoom",{currentMagnifierSize:t.magnifierSize});i!=null&&i.magnifierSize&&(t.magnifierSize=i.magnifierSize,w(t.element))}}class sr{execute(t){t.magnifierSize=4,w(t.element)}}class ar{execute(t){t.magnifierSize=1,w(t.element)}}class lr{isChecked(t){return t.text.showToolbar??!1}canExecute(t){return t.text.active}execute(t){t.text.showToolbar=!t.text.showToolbar,tt(t),w(t.element)}}class cr{async execute({canvas:t}){t&&await t.requestFullscreen()}}class hr{isChecked({view:{statusBar:t}}){return t}execute(t){t.view.statusBar=!t.view.statusBar,w(t.element)}}class pr{isChecked({view:{toolBox:t}}){return t}execute(t){t.view.toolBox=!t.view.toolBox,w(t.element)}}class dr{isChecked({view:{colorBox:t}}){return t}execute(t){t.view.colorBox=!t.view.colorBox,w(t.element)}}const ur={caption:"View",mnemonic:"V",helpText:"",entries:[{caption:"Tool Box",shortcut:"Ctrl+T",mnemonic:"T",helpText:"Shows or hides the tool box.",instance:new pr},{caption:"Color Box",shortcut:"Ctrl+A",mnemonic:"C",helpText:"Shows or hides the color box.",instance:new dr},{caption:"Status Bar",mnemonic:"S",helpText:"Shows or hides the status bar.",instance:new hr},{separator:!0},{caption:"Zoom",mnemonic:"Z",helpText:"",entries:[{caption:"Normal Size",mnemonic:"N",shortcut:"Ctrl+PgUp",helpText:"Zooms the picture to 100%.",instance:new ar},{caption:"Large Size",mnemonic:"L",shortcut:"Ctrl+PgDn",helpText:"Zooms the picture to 400%.",instance:new sr},{caption:"Custom…",mnemonic:"u",helpText:"Zooms the picture.",instance:new rr},{separator:!0},{caption:"Show Grid",mnemonic:"G",shortcut:"Ctrl+G",helpText:"Shows or hides the grid."},{caption:"Show Thumbnail",mnemonic:"h",helpText:"Shows or hides the thumbnail view of the picture."}]},{caption:"View Bitmap",mnemonic:"V",shortcut:"Ctrl+F",helpText:"Displays the entire picture.",instance:new cr},{caption:"Text Toolbar",mnemonic:"e",helpText:"Shows or hides the text toolbar.",instance:new lr}]},ei=[Go,No,ur,tr,or,Zo];var fr=Object.defineProperty,gr=Object.getOwnPropertyDescriptor,xt=(e,t,i,n)=>{for(var o=n>1?void 0:n?gr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&fr(t,i,o),o};const te="For Help, click Help Topics on the Help Menu.";let J=class extends b{constructor(){super(),this.areaText="",this.coordinateText="",this.helpText=te,this.drawingContext=_,this.previousTitle="",this.areaText="",this.coordinateText="",this.helpText=te,this.drawingContext=_,this.drawingContext.history=new bo(this.drawingContext),this.addEventListener("set-help-text",e=>{this.helpText=e.detail??te}),this.addEventListener("coordinate",e=>{this.coordinateText=e.detail?`${e.detail.x},${e.detail.y}`:""}),this.addEventListener("area",e=>{this.areaText=e.detail?`${e.detail.width}x${e.detail.height}`:""}),this.addEventListener("drawing-context-changed",e=>{const t=e.detail;go(t),this.drawingContext=t}),this.addEventListener("invoke-action",e=>{e.detail(this.drawingContext)}),this.addEventListener("canvas-ready",()=>vo(this.drawingContext)),this.beforeUnloadListener=this.onBeforeUnload.bind(this),window.addEventListener("beforeunload",this.beforeUnloadListener),xo(this),this.registerHotkeys(ei)}static get styles(){return A`
    ...
    </div>`}};ii=br([y("paint-button")],ii);var wr=Object.defineProperty,xr=Object.getOwnPropertyDescriptor,it=(e,t,i,n)=>{for(var o=n>1?void 0:n?xr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&wr(t,i,o),o};let Q=class extends b{constructor(){super(...arguments),this.drawingContext=_,this.inCanvas=!1,this.canvasWidth=screen.width,this.canvasHeight=screen.height,this.pointerDown=!1,this.previewColor="primary",this.lastPointerEventTime=0}static get styles(){return A`
      :host {
        height: 100%;
    ...
    `}swapColors({pointerType:e}){if(["pen","touch"].includes(e)){const{primary:t,secondary:i}=this.drawingContext.colors;this.drawingContext.colors.primary=i,this.drawingContext.colors.secondary=t,w(this)}}};Ui([m()],de.prototype,"drawingContext",2);de=Ui([y("paint-color-box")],de);var $r=Object.defineProperty,Pr=Object.getOwnPropertyDescriptor,Be=(e,t,i,n)=>{for(var o=n>1?void 0:n?Pr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&$r(t,i,o),o};let Dt=class extends b{constructor(){super(),this.drawingContext=_,this.color="",this.addEventListener("click",()=>{this.dispatchColorEvent("primary")}),this.addEventListener("contextmenu",e=>{this.dispatchColorEvent("secondary"),e.preventDefault()})}static get styles(){return A`
      :host {
        border: 1px solid var(--button-light);
    ...
    ></div>`}};Be([m()],Dt.prototype,"drawingContext",2);Be([m()],Dt.prototype,"color",2);Dt=Be([y("paint-color-picker")],Dt);var Cr=Object.defineProperty,Er=Object.getOwnPropertyDescriptor,Le=(e,t,i,n)=>{for(var o=n>1?void 0:n?Er(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Cr(t,i,o),o};let Vt=class extends b{constructor(){super(...arguments),this.primaryColor="",this.secondaryColor=""}static get styles(){return A`
      :host {
        border: 1px solid var(--button-light);
        border-top-color: var(--button-dark);
        border-left-color: var(--button-dark);
    ...
    `}};Le([m()],Vt.prototype,"primaryColor",2);Le([m()],Vt.prototype,"secondaryColor",2);Vt=Le([y("paint-color-switcher")],Vt);var _r=Object.defineProperty,Sr=Object.getOwnPropertyDescriptor,Or=(e,t,i,n)=>{for(var o=n>1?void 0:n?Sr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&_r(t,i,o),o};let ni=class extends b{static get styles(){return A`
      :host {
        display: inline-block;
        box-sizing: border-box;
        width: 3px;
    ...
    `}render(){return f``}};ni=Or([y("paint-handle")],ni);var Tr=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,Hr=(e,t,i,n)=>{for(var o=n>1?void 0:n?Mr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Tr(t,i,o),o};let oi=class extends b{static get styles(){return A`
      :host {
        box-sizing: border-box;
        border: 1px solid var(--button-dark);
        border-bottom-color: var(--button-light);
    ...
    `}render(){return f`<slot></slot>`}};oi=Hr([y("paint-inset-container")],oi);var Dr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,Re=(e,t,i,n)=>{for(var o=n>1?void 0:n?Vr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Dr(t,i,o),o};let kt=class extends b{constructor(){super(),this.entries=[],this.drawingContext=_,this.addEventListener("click",e=>e.stopPropagation())}static get styles(){return A`
      :host {
        position: absolute;
        top: 100%;
        left: 0;
    ...
    `}isChecked(e){var t;return!!((t=e.instance)!=null&&t.isChecked&&e.instance.isChecked(this.drawingContext))}isDisabled({instance:e,entries:t}){return!(t||e&&(!e.canExecute||e.canExecute(this.drawingContext)))}execute(e){var t;!this.isDisabled(e)&&((t=e.instance)!=null&&t.execute)&&(this.dispatchEvent(new CustomEvent("invoke-action",{detail:e.instance.execute.bind(e.instance),bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("action-executed",{bubbles:!0,composed:!0})))}setHelpText(e){this.dispatchEvent(new CustomEvent("set-help-text",{detail:e,bubbles:!0,composed:!0}))}};Re([m()],kt.prototype,"entries",2);Re([m()],kt.prototype,"drawingContext",2);kt=Re([y("paint-menu")],kt);var kr=Object.defineProperty,Br=Object.getOwnPropertyDescriptor,zt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Br(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&kr(t,i,o),o};let ut=class extends b{constructor(){super(),this.entries=[],this.drawingContext=_,this.activeMenu=null,document.addEventListener("click",()=>this.activeMenu=null),this.addEventListener("action-executed",()=>this.activeMenu=null)}static get styles(){return A`
      :host {
        background-color: var(--button-face);
        display: flex;
        height: 20px;
...
`)).reduce((x,R)=>x.concat(R),[]).forEach((x,R)=>{const O=(t??0)+d,S=(i??0)+r+g*R;if(!(S-(i??0)>=(o??0))&&(e.fillText(x,O,S),p)){const{width:j}=e.measureText(x);e.fillRect(O,S+1,j,1)}})}static getLineHeight(e,t){const i=e.measureText("");return typeof i.fontBoundingBoxAscent=="number"&&typeof i.fontBoundingBoxDescent=="number"?i.fontBoundingBoxAscent+i.fontBoundingBoxDescent:t*1.2}};Ue([m()],gt.prototype,"drawingContext",2);Ue([fi("textarea")],gt.prototype,"textarea",2);gt=Ue([y("paint-text-area")],gt);var Xr=Object.defineProperty,Zr=Object.getOwnPropertyDescriptor,Ii=(e,t,i,n)=>{for(var o=n>1?void 0:n?Zr(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&Xr(t,i,o),o};let ue=class extends b{static get styles(){return A`
      :host {
        display: inline-block;
        box-sizing: border-box;
        width: 25px;
    ...
    `}setSize(e){this.drawingContext.airbrushSize=e,w(this)}};zi([m({type:Object})],fe.prototype,"drawingContext",2);fe=zi([y("paint-tool-airbrush")],fe);var ts=Object.defineProperty,es=Object.getOwnPropertyDescriptor,is=(e,t,i,n)=>{for(var o=n>1?void 0:n?es(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ts(t,i,o),o};let si=class extends b{static get styles(){return A`
      :host {
        background-color: var(--button-face);
        padding-right: 1px;
      }
    `}render(){return f`<slot></slot>`}};si=is([y("paint-tool-bar")],si);var ns=Object.defineProperty,os=Object.getOwnPropertyDescriptor,je=(e,t,i,n)=>{for(var o=n>1?void 0:n?os(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ns(t,i,o),o};let Bt=class extends b{constructor(){super(...arguments),this.drawingContext=_}static get styles(){return A`
      :host {
        display: flex;
        flex-flow: row wrap;
    ...
    `}selectTool(e){this.drawingContext.text.active=!1,tt(this.drawingContext),this.isEditingTool(this.drawingContext.tool)&&(this.drawingContext.previousEditingTool=this.drawingContext.tool),this.drawingContext.tool=e,w(this)}isEditingTool(e){return[re,oe,ae,ne,se,Ot,ce,le,he].includes(e)}getToolHtml(e){return Ai===e?f` <paint-tool-color-preview
      ...
      ></paint-tool-color-preview>`:[se,ae].includes(e)?f` <paint-tool-line-width
        .drawingContext="${this.drawingContext}"
      ></paint-tool-line-width>`:[le,Pi,ce,he].includes(e)?f` <paint-tool-fill-style
        .drawingContext="${this.drawingContext}"
    ...
    `}render(){return f`${this.brushConfigs.map(({type:e,sizes:t})=>t.map(({value:i,path:n})=>f`<div
        ...
        </div>`))}`}onSelect(e,t){this.drawingContext.brush.type=e,this.drawingContext.brush.size=t,w(this)}};Ni([m()],ge.prototype,"drawingContext",2);ge=Ni([y("paint-tool-brush")],ge);var as=Object.defineProperty,ls=Object.getOwnPropertyDescriptor,Ki=(e,t,i,n)=>{for(var o=n>1?void 0:n?ls(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&as(t,i,o),o};let ve=class extends b{constructor(){super(...arguments),this.drawingContext=_}static get styles(){return A`
      :host {
        display: block;
      }
    `}render(){var e;this.style.backgroundColor=((e=this.drawingContext)==null?void 0:e.previewColor)??"transparent"}};Ki([m()],ve.prototype,"drawingContext",2);ve=Ki([y("paint-tool-color-preview")],ve);var cs=Object.defineProperty,hs=Object.getOwnPropertyDescriptor,Wi=(e,t,i,n)=>{for(var o=n>1?void 0:n?hs(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&cs(t,i,o),o};let me=class extends b{constructor(){super(...arguments),this.drawingContext=_}static get styles(){return A`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 1px 0;
    ...
    `}getClasses(e){return[...e===this.drawingContext.drawOpaque?["selected"]:[],...e?["opaque"]:["transparent"]].join(" ")}selectValue(e){this.drawingContext.drawOpaque=e,w(this)}};Wi([m()],me.prototype,"drawingContext",2);me=Wi([y("paint-tool-draw-opaque")],me);var ps=Object.defineProperty,ds=Object.getOwnPropertyDescriptor,Qi=(e,t,i,n)=>{for(var o=n>1?void 0:n?ds(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&ps(t,i,o),o};let be=class extends b{constructor(){super(...arguments),this.drawingContext=_,this.eraserSizes=[4,6,8,10]}static get styles(){return A`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 1px;
    ...
    `}isSelected({stroke:e,fill:t}){return e===this.drawingContext.fillStyle.stroke&&t===this.drawingContext.fillStyle.fill}getClasses({stroke:e,fill:t}){return[...e?["stroke"]:[],...t?["fill"]:[]].join(" ")}onSelect(e){this.drawingContext.fillStyle=e,w(this)}};qi([m()],we.prototype,"drawingContext",2);we=qi([y("paint-tool-fill-style")],we);var gs=Object.defineProperty,vs=Object.getOwnPropertyDescriptor,Gi=(e,t,i,n)=>{for(var o=n>1?void 0:n?vs(t,i):t,r=e.length-1,s;r>=0;r--)(s=e[r])&&(o=(n?s(t,i,o):s(o))||o);return n&&o&&gs(t,i,o),o};let xe=class extends b{constructor(){super(...arguments),this.drawingContext=_,this.lineWidths=[1,2,3,4,5]}static get styles(){return A`
      ul {
        list-style-type: none;
        margin: 0;
        padding: 1px 2px;
    ...
    `}onUpdateWidth(e){this.drawingContext.lineWidth=e,w(this)}};Gi([m()],xe.prototype,"drawingContext",2);xe=Gi([y("paint-tool-line-width")],xe);var li;(li=document.querySelector("paint-app"))==null||li.addEventListener("titlechange",e=>document.title=`${e.detail.title} - Paint`);"serviceWorker"in navigator&&window.addEventListener("load",()=>navigator.serviceWorker.register("/sw.js"));
