...
export let ToolAirbrush = class extends LitElement {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return html`
      <ul>
        ${this.options.map(({size, selectionWidth, width, height, path}) => html`
              <li
...
], ToolAirbrush.prototype, "drawingContext", 2);
ToolAirbrush = __decorate([
