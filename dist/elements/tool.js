...
export let Tool = _decorate([customElement('paint-tool')], function (_initialize, _LitElement) {
  class Tool extends _LitElement {
    constructor() {
      super();
      _initialize(this);
      ...
      this.addEventListener('pointerleave', () => this.dispatchEvent(new CustomEvent('set-help-text', {
        bubbles: true,
        composed: true
      })));
    }
